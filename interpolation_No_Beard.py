...
raw_imgs = ["010007.jpg"]  # You can add more images, e.g., ["010007.jpg", "000008.jpg", ...]
...
params.target_attribute_list = ["No_Beard"]
...
def generate_attribute_interpolations(
    ...
    # Generate interpolation values from 0 to 1
...
if __name__ == "__main__":
    ...
    model_path = "train_model/best_autoencoder_No_Beard.pth"
    ...
    for img_name in raw_imgs:
        ...
        test_img_path = r"dataset\img_align_celeba\010007.jpg"
