...
# Convert YAML configuration dictionary to Config object
params = Config(params_dict)

img_directory = params.raw_img_directory  # Path to the image folder
attributes_file = params.raw_attributes_file  # Path to the attribute file
save_directory = params.preprocess_save_directory  # Path to save processed data
image_size = params.image_size  # Image resizing size, default is 256
